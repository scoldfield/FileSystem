	...
	<form action="${pageContext.request.contextPath }/fileMng/list" method="post">
		<table border="1" width="920" cellspacing="0" cellpadding="0" bgcolor="white" align="center">
			...
			<tr align="center" height="40" >
				...
				<td>
					<fmt:formatDate value="${fileDto.generateDate }" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
			</tr>
			<tr align="center" height="40" >
				<td>
			...
			<tr align="center" height="40" >
				...
				<td>
                    <c:if test="${fileDto.auditResult=='0' }">未被审核，不可借阅</c:if>
                    <c:if test="${fileDto.auditResult=='-1' }">审核不通过，不可借阅</c:if>
                    <c:if test="${fileDto.auditResult=='1' }"> <!-- 已经审核过，且审核通过 -->
