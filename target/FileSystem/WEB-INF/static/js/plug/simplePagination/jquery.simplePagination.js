...
(function($){
    ...
    var methods = {
        ...
        drawPage: function(page, pageCount){
            var o = this.data('pagination');
            o.currentPage = page - 1;
            pageCount && (o.items = pageCount);
        ...
        _draw: function(){
            ...
            //总页
            $panel.prepend('<li class="pageInfo"><span class="page-mdl">共 <i class="j-paginationTotal" style="font-style:normal">' + o.items + '</i> 条 第' + (o.currentPage + 1) + '/' + o.pages + '页 </span></li>');
            // Generate Prev link
            if(o.prevText){
            ...
            var jumpInfo = $('<span></span>');
            var jumpPagesize = $('<input type="text" id="pagenationSize" class="page-input" value="' + o.itemsOnPage + '">');
            var jumpPage = $('<input type="text" id="pagenationNumber" class="page-input" >');
            var jumpMDL = $('<li></li>');
            jumpPage.val(o.currentPage + 1 > o.pages ? o.currentPage : o.currentPage + 1);
            ...
            jump.click(function(event){
                ...
                o.onPageClick({
                    ...
                    methods.drawPage.call(_self, textPage, pageCount);
                });
                //methods.drawPage.call(_self, textPage);
            });
...
Pagination.prototype.paginationFn = function(parmester){
    ...
    _Pagination.tabPagination.pagination({
        ...
        onPageClick: function(page, callBack){
            parmester.pageNumber = page.pageNumber;
            parmester.itemsOnPage = page.pageSize;
            _Pagination.rendenList(parmester, callBack);
        }
    });
};

Pagination.prototype.rendenList = function(parmester, callBack){
    var _Pagination = this;
    $.ajax({
        ...
        success: function(resObjData){
            if(resObjData){
                ...
                //为了数据体的突变，跳转/翻页等操作（出首页页面加载外）更新总条数，
                callBack && callBack(_Pagination.pageCount);
