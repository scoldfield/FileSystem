 ...
 * under the License.
 */
package com.cmcc.filesystem.shiro.session.mgt.quartz;
...
public class QuartzSessionValidationScheduler implements SessionValidationScheduler {
    ...
    public void enableSessionValidation() {
        ...
        try {
	        ...
	        trigger.setName(getClass().getName());
...
//                    sessionValidationInterval);
	        ...
	        detail.setName(JOB_NAME);
	        detail.setGroup(Scheduler.DEFAULT_GROUP);
	        detail.setJobClass(QuartzSessionValidationJob.class);
