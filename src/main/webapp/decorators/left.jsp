    ...
    <body>
        ...
        <div id="firstpane" class="menu_list">
            <shiro:hasPermission name="user:mngt">
                <h2 class="menu_head current">用户管理</h2>
            ...
            <shiro:hasPermission name="borrow:mngt">
                ...
                <div style="display: none" class="menu_body">
                    ...
                    <a href="${pageContext.request.contextPath }/borrow/myBorrow">借阅申请记录</a>
                </div>
            </shiro:hasPermission>
            
            <shiro:hasPermission name="biz:mngt">
                <h2 class="menu_head">业务管理</h2>
                <div style="display: none" class="menu_body">
                    <shiro:hasPermission name="biz:recv">
                        <a href="${pageContext.request.contextPath }/fileMng/add">档案录入</a>
                    </shiro:hasPermission>
                    <a href="${pageContext.request.contextPath }/fileMng/addRecord">档案录入记录</a>
                    <shiro:hasPermission name="biz:recevAudit">
                        <a href="${pageContext.request.contextPath }/biz/receiveAudit">录入档案审核</a>
                    </shiro:hasPermission>
...
//    								$("#firstpane .menu_body:eq(0)").show();
    								...
    								$("#secondpane h2.menu_head").mouseover(
    										function() {
    											$(this).addClass("current").next(
